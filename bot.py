...
async def main():
    ...
    # Список чатов MAX больше не отдаёт через GET /chats.
    # Каталог ресурсов ведём локально через webhook-события bot_added/bot_removed
    # и ручное добавление chat_id из админки.
